...
app.post("/emails/store-approval", async (req, res) => {
  try {
    ...
    const { email, merchantId, password } = req.body;
    ...
    const dashboardUrl = `https://dmarketplace-merchant.vercel.app`;
    ...
    const htmlContent = `
      ...
      <head>
        <style>
          ...
          .credentials-box { background: white; border: 2px solid #10b981; border-radius: 8px; padding: 20px; margin: 25px 0; }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <h3 style="color: #065f46;">🔐 Your Login Credentials</h3>
            ...
            <div class="warning-box">
              ...
              <p style="margin: 10px 0 0 0;">This is your temporary password. Please log in and change it immediately from your dashboard settings for security purposes.</p>
            </div>
            ...
            <div class="footer">
              ...
              <p style="color: #ef4444; font-size: 12px; margin-top: 10px;">⚠️ Please keep your credentials secure and do not share them with anyone.</p>
            </div>
          </div>
        </div>
      </body>
...
⚠️ IMPORTANT: This is your temporary password. Please log in and change it immediately from your dashboard settings for security purposes.
